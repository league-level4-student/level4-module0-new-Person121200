...
public class IntroToEncapsulation {
	...
	public static void main(String[] args) {
		...
		System.out.println(vehicle.getFuelInTank() + " " + vehicle.getMpg() + " " + vehicle.getColor() + " "+ vehicle.getFuelTankCapacity());
		vehicle.drive();
		
		// 7. Use the vehicle's setters to initialize all of them.
